...
def index(request):
    ...
    summer_sale = Product.objects.filter(summer_sale=True, product_status="published")
...
def category(request, main_title):
    ...
    for product in products:
        ...
        gst_amounts[product.id] = gst_amount
...
def search_view(request):
    ...
    products = Product.objects.filter(title__icontains=query).order_by("-date").filter(product_status='published')
